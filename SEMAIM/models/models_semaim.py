...
class AimViT(nn.Module):
    ...
    def generate_attention_mask(self, x, attention_maps=None):
       ...
       """
        ...
        # elif self.permutation_type == 'token_order':
        #     assert token_orders is not None, "token_orders must be provided for 'token_order' permutation type"
        #     permutation = token_orders.float().to(x.device)
