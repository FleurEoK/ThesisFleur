...
#  Imports the FALcon_config/ what is contained?
...
# Expand $HOME or ~ in dataset_dir
config_3.dataset_dir = os.path.expandvars(os.path.expanduser(config_3.dataset_dir))

# Optional safety check (prints once):
print("Resolved dataset_dir →", pathlib.Path(config_3.dataset_dir).resolve())
...
# forces use of determinsitic algos in cuDNN used for GPU acceleration
torch.backends.cudnn.deterministic = True
# disables the cuDNN benchmarking features which selects the  best algo from the hardware
